...
| 2026-04-20 | Atlassian Bug Bounty | Hunt #10 — 1 MEDIUM (Apollo Tracing), 2 INFO (GraphQL Introspection 25,796 types, SDL Enum). Marketplace GraphQL has 25,796 types + AI/Rovo types. CVE-2023-22515 weaponized but no Confluence accessible. All GraphQL mutations require auth. Est. Bounty: $0. Need test instance for P1/P2. | ACTIVE |
